...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-info">
            <a class="navbar-brand" href="index.php">Buy-Style</a>
   ...
   <!-- Navbar-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-info" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="menform.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Insert Man Product
                            </a>
                            <a class="nav-link" href="womenform.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Insert women Product
                            </a>
                        </div>
                    </div>
                    ...
                    <div  class="container-fluid text-center" id="contact" style="background-image: url('Images/bb.png'); padding-top: 20px;">
                        <div class="row">
                            <div class="col-md-6" style="padding-top: 20px;">
                                <h1 class="text-black display-5 bg-warnging" >Product Insert In Man Page</h1>
    ...
    <!-- Insert Products Coding -->
        ...
        if(isset($_POST['productinsert'])){
            ...
            $price=$_POST["price"];
            $query="INSERT INTO  gallery VALUES (Null,'$folder','$title','$discription','$price')";
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <divclass="text-muted">Copyright &copy; BuyStyle 2020</div>
                        </div>
                    </div>
                </footer>
            </div>
